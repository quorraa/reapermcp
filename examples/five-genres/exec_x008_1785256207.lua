local LOG = [[C:\Wizardry\media\audio\reapermcp\examples\five-genres\exec_x008_1785256207.log]]
...
local __ok, __err = pcall(function()
  local proj = findproj([[Cinematic in D minor]])
  ...
  LEVEL["counter"] = 0.22
  local TIMBRE = {}
  TIMBRE["lead"] = {[0]=0.35, [1]=0.55, [2]=0.0, [3]=0.1, [4]=0.75, [6]=0.6, [7]=0.55, [9]=1.0}
  ...
  local FX = {}
  FX["lead"] = {[[VST: ReaEQ (Cockos)]], [[VST: ReaVerbate (Cockos)]]}
  FX["harmony"] = {[[VST: ReaEQ (Cockos)]], [[VST: ReaVerbate (Cockos)]]}
  FX["bass"] = {[[VST: ReaEQ (Cockos)]]}
  FX["counter"] = {[[VST: ReaEQ (Cockos)]], [[VST: ReaDelay (Cockos)]], [[VST: ReaVerbate (Cockos)]]}
  ...
  reaper.Main_SaveProjectEx(proj, [[C:/Wizardry/media/audio/qlabs-songs\04_cinematic.RPP]], 0)
  say("saved " .. [[C:/Wizardry/media/audio/qlabs-songs\04_cinematic.RPP]])
  reaper.GetSetProjectInfo_String(proj, "RENDER_FILE", [[C:/Wizardry/media/audio/qlabs-songs]], true)
  reaper.GetSetProjectInfo_String(proj, "RENDER_PATTERN", [[04_cinematic]], true)
