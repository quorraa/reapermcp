local LOG = [[C:\Wizardry\media\audio\reapermcp\examples\five-genres\exec_x004_1785255240.log]]
...
local __ok, __err = pcall(function()
  local proj = findproj([[Neo-Soul in E-flat]])
  ...
  LEVEL["counter"] = 0.18
  local TIMBRE = {}
  TIMBRE["lead"] = {[0]=0.01, [1]=0.28, [2]=0.0, [3]=0.08, [4]=0.8, [6]=0.35, [7]=0.6, [9]=0.75}
  TIMBRE["harmony"] = {[0]=0.01, [1]=0.28, [2]=0.0, [3]=0.08, [4]=0.8, [6]=0.35, [7]=0.6, [9]=0.75}
  TIMBRE["bass"] = {[0]=0.01, [1]=0.18, [2]=0.0, [3]=0.3, [4]=0.55, [6]=0.4, [7]=0.7, [9]=0.9}
  TIMBRE["counter"] = {[0]=0.35, [1]=0.55, [2]=0.0, [3]=0.1, [4]=0.75, [6]=0.6, [7]=0.55, [9]=1.0}
  local FX = {}
  FX["lead"] = {[[VST: ReaEQ (Cockos)]], [[JS: Chorus]], [[VST: ReaComp (Cockos)]]}
  FX["harmony"] = {[[VST: ReaEQ (Cockos)]], [[JS: Chorus]], [[VST: ReaVerbate (Cockos)]]}
  FX["bass"] = {[[VST: ReaEQ (Cockos)]], [[VST: ReaComp (Cockos)]]}
  FX["counter"] = {[[VST: ReaEQ (Cockos)]], [[VST: ReaDelay (Cockos)]]}
  FX["master"] = {[[VST: ReaComp (Cockos)]], [[VST: ReaLimit (Cockos)]]}
  ...
  reaper.TrackFX_AddByName(master, [[VST: ReaComp (Cockos)]], false, -1)
  reaper.TrackFX_AddByName(master, [[VST: ReaLimit (Cockos)]], false, -1)
  reaper.SetMediaTrackInfo_Value(master, "D_VOL", 0.85)
  reaper.Main_SaveProjectEx(proj, [[C:/Wizardry/media/audio/qlabs-songs\02_neo_soul.RPP]], 0)
  say("saved " .. [[C:/Wizardry/media/audio/qlabs-songs\02_neo_soul.RPP]])
  reaper.GetSetProjectInfo_String(proj, "RENDER_FILE", [[C:/Wizardry/media/audio/qlabs-songs]], true)
  reaper.GetSetProjectInfo_String(proj, "RENDER_PATTERN", [[02_neo_soul]], true)
