local LOG = [[C:\Wizardry\media\audio\reapermcp\examples\five-genres\exec_x001_1785255880.log]]
...
local __ok, __err = pcall(function()
  ...
  local N = {
    ...
    {72, 44.0, 47.0, 76},
    {70, 48.0, 48.938, 88},
    {67, 48.938, 49.876000000000005, 84},
    {69, 49.875, 50.5, 72},
    {72, 50.5, 52.375, 85},
    {72, 52.25, 53.188, 72},
    {69, 53.188, 53.876000000000005, 72},
    {70, 53.875, 54.5, 87},
    {74, 54.5, 56.375, 83},
    {69, 56.25, 56.938, 73},
