local LOG = [[C:\Wizardry\media\audio\reapermcp\examples\five-genres\exec_x002_1785255707.log]]
...
local __ok, __err = pcall(function()
  ...
  local N = {
    ...
    {72, 44.0, 47.0, 76},
    {64, 48.0, 48.938, 81},
    {60, 49.188, 49.876000000000005, 85},
    {62, 50.125, 50.5, 72},
    {65, 50.75, 52.375, 72},
    {65, 52.0, 52.938, 87},
    {62, 52.938, 53.876000000000005, 83},
    {64, 54.125, 54.5, 73},
    {67, 54.5, 56.375, 85},
    {62, 56.0, 56.938, 83},
