local LOG = [[C:\Wizardry\media\audio\reapermcp\examples\five-genres\exec_x010_1785256219.log]]
...
local __ok, __err = pcall(function()
  local proj = findproj([[Twelve-Bar Blues in E]])
  ...
  LEVEL["bass"] = 0.42
  local TIMBRE = {}
  TIMBRE["lead"] = {[0]=0.01, [1]=0.2, [2]=0.55, [3]=0.6, [4]=0.15, [6]=0.25, [7]=0.1, [9]=0.6}
  TIMBRE["harmony"] = {[0]=0.02, [1]=0.22, [2]=0.05, [3]=0.15, [4]=0.7, [6]=0.3, [7]=0.45, [9]=0.85}
  TIMBRE["bass"] = {[0]=0.02, [1]=0.15, [2]=0.0, [3]=0.2, [4]=0.65, [6]=0.3, [7]=0.55, [9]=0.8}
  local FX = {}
  FX["lead"] = {[[VST: ReaEQ (Cockos)]], [[JS: Distortion]], [[VST: ReaComp (Cockos)]]}
  FX["harmony"] = {[[VST: ReaEQ (Cockos)]], [[VST: ReaComp (Cockos)]]}
  ...
  reaper.Main_SaveProjectEx(proj, [[C:/Wizardry/media/audio/qlabs-songs\05_blues.RPP]], 0)
  say("saved " .. [[C:/Wizardry/media/audio/qlabs-songs\05_blues.RPP]])
  reaper.GetSetProjectInfo_String(proj, "RENDER_FILE", [[C:/Wizardry/media/audio/qlabs-songs]], true)
  reaper.GetSetProjectInfo_String(proj, "RENDER_PATTERN", [[05_blues]], true)
